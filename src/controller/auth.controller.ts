...
import AuthHelper from "../controller-helper/auth.helper";
...
class AuthController implements Controller {
    ...
    public userSignup = async (req: Request, res: Response) => {
        ...
        const userData = await AuthHelper.userSignup(email, name, password);
    ...
    public userLogin = async (req: Request, res: Response) => {
        const email = String(req.body.email);
        const password = String(req.body.password);
        const userData = await AuthHelper.userLogin(email, password);
        if (userData.error) {
            return sendResponse(res, userData);
        }
    ...
    public userLogut = async (req: Request, res: Response) => {
        ...
        const logoutData = await AuthHelper.userLogout(user);
        if (!logoutData?.error) {
    ...
    public forgetPassword = async (req: Request, res: Response) => {
        const email = String(req.body.email);
        const responseForgetPassword = await AuthHelper.forgetPassword(email);
    ...
    public userChangePassword = async (req: Request, res: Response) => {
        ...
        const responseData = await AuthHelper.userChangePassword(oldPassword, newPassword, email);
    ...
    public userGetList = async (req: Request, res: Response) => {
        const responseData = await AuthHelper.getUserList();
        return sendResponse(res, responseData)
    }
    /**
    ...
    public sendOTP = async (req: Request, res: Response) => {
        ...
        const responseData = await AuthHelper.sendOTP(phone);
        return sendResponse(res, responseData);
    }
    /**
    ...
    public verifyOTP = async (req: Request, res: Response) => {
        ...
        const responseData = await AuthHelper.verifyOTP(phone, otp);
        return sendResponse(res, responseData);
    }
    /**
     * The user can send the otp on thier mobile
    ...
    public sendOTPEmail = async (req: Request, res: Response) => {
        const email = String(req.body.email);
        const responseData = await AuthHelper.sendOTPEmail(email);
        return sendResponse(res, responseData);
    }
    /**
     * The user can verify the otp send on the mobile
    ...
    public verifyOTPEmail = async (req: Request, res: Response) => {
        const email = String(req.body.email);
        const otp = String(req.body.otp);
        const responseData = await AuthHelper.verifyOTPEmail(email, otp);
        return sendResponse(res, responseData);
    }
    /**
     * The user can change the password of the account
    ...
    public userResetPassword = async (req: Request, res: Response) => {
        ...
        const newPassword = String(req.body.new_password);
        const responseData = await AuthHelper.userChangePasswordEmail(token, newPassword);
        return sendResponse(res, responseData);
    }
    /**
    ...
    public userGenerateMFASecret = async (req: any, res: Response) => {
        const user = req.user;
        const responseData = await AuthHelper.userGenerateMFASecret(user);
        return sendResponse(res, responseData);
    }
    /**
    ...
    public verifyMFASecret = async (req: any, res: Response) => {
        const token = String(req.body.token);
        const user = req.user;
        const responseData = await AuthHelper.verifyMFASecret(token, user);
